...
Notre étude porte sur l'analyse de la consommation d'énergie dans les 33 Etats d'Inde.
...
Au départ, nous avons voulu normaliser les données par le nombre d'habitants de chaque Etat. Cependant, cette méthode s'est révélée problématique car nous avons obtenu des valeurs très proches de zéro, ce qui aurait compliqué les calculs.
